...
(function () {
  ...
  var CAT = [
    ...
    { id: "shelf-of-stories", name: "Shelf of Stories", cat: "milestone", tier: "gold", img: "book-gold.png", desc: "Published five works.",                   how: "Publish five works. Earned automatically.", auto: function (s) { return (s.works || 0) >= 5; } },
    { id: "wordsmith",     name: "Wordsmith",      cat: "milestone", tier: "gold",   img: "feather-gold.png",  desc: "Wrote fifty thousand words on Wisp.",     how: "Publish 50,000 words across your works. Earned automatically.", auto: function (s) { return (s.words || 0) >= 50000; } },
    ...
    { id: "breakout",      name: "Breakout",       cat: "milestone", tier: "gold",   img: "star-burst.png",    desc: "Hit five hundred hearts.",                how: "Reach 500 hearts across your works. Earned automatically.", auto: function (s) { return (s.hearts || 0) >= 500; } },
    ...
    // Ratings ----------------------------------------------------------------
    { id: "first-rating",  name: "First Rating",   cat: "rating",  tier: "bronze", img: "star-1.png",        desc: "A reader rated one of the works.", how: "Get your first reader rating. Earned automatically.", auto: function (s) { return (s.ratingsCount || 0) >= 1; } },
    { id: "talked-about",  name: "Talked About",   cat: "rating",  tier: "bronze", img: "star-2.png",        desc: "Ten reader ratings and counting.", how: "Collect ten ratings across your books. Earned automatically.", auto: function (s) { return (s.ratingsCount || 0) >= 10; } },
