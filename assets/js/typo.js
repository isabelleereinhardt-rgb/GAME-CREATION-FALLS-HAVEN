/* Typo.js — a JavaScript spellchecker using Hunspell-style dictionaries.
 * By Chris Finke, released under the Modified BSD License. Vendored for Wisp
 * so the writing station can spell-check with the same en_US Hunspell dictionary
 * that browsers (which also use Hunspell) underline words against. Unmodified.
 */
